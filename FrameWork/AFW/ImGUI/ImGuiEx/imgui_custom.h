...
struct Input_Filters
{
    ...
    static int number(ImGuiInputTextCallbackData* data)
    {
        if (data->EventChar < 256 && strchr("0123456789.-e^", (char)data->EventChar))
            return 0;
        return 1;
    }
};
...
#define IMGUI_WINDOW_BORDER_NONE   -1
#define IMGUI_WINDOW_BORDER_LEFT   0
#define IMGUI_WINDOW_BORDER_RIGHT  1
#define IMGUI_WINDOW_BORDER_TOP    2
#define IMGUI_WINDOW_BORDER_BOTTOM 3
